...
@Component({
  selector: 'doo-favorites-spawner',
  templateUrl: './product-cards-spawner.component.html',
  styleUrls: ['./product-cards-spawner.component.scss'],
})
export class FavoritesCardsSpawnerComponent implements OnInit {
  @ViewChild('spawnfavorites', { read: ViewContainerRef, static: true }) container;
